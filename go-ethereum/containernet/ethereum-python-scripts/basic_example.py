...
#    volumes=["/home/ubuntu/container-chain/ethdata:/app/ethdata"]
    ...
    boot = net.addDocker('boot', ip='10.0.0.2', dimage="custom-ethereum-image:bootnode", volumes=[
                         "/home/ubuntu/container-chain/go-ethereum/eth-scripts:/app/eth-scripts"], port_bindings={8545: 8547, 30301: 30301}, cpu_shares=20, publish_all_ports=False)
    ...
    d1 = net.addDocker('d1', ip='10.0.0.5', dimage="custom-ethereum-image:master", volumes=["/home/ubuntu/container-chain/go-ethereum/ethdata:/app/ethdata",
                       "/home/ubuntu/container-chain/go-ethereum/eth-scripts:/app/eth-scripts"], port_bindings={8545: 8545, 30303: 30303}, cpu_shares=20, publish_all_ports=False)
    d2 = net.addDocker('d2', ip='10.0.0.6', dimage="custom-ethereum-image:node", volumes=[
                       "/home/ubuntu/container-chain/go-ethereum/eth-scripts:/app/eth-scripts"], port_bindings={8545: 8546, 30303: 30304}, cpu_shares=20, publish_all_ports=False)
